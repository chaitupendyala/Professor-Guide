...
public class Get_attendance_report extends AsyncTask<String,String,String> {
    String a;
    public Get_attendance_report(String a){
        this.a = a;
    }
    @Override
    protected String doInBackground(String... params) {
        try {
            URL url = new URL("http://<<SYSTEM-IP>>:<<PORT-NO>>/complete_attendance_report");
